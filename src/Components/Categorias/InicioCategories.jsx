    ...
    <div>
      ...
      <div className="Section-Categories">
            ...
            <div className="Self-Categories">
              <img src="https://drive.google.com/uc?export=download&id=1IxFcPchD2JBK_fcb7A6vM5hBTQMfwQ3Q"></img>
              <Link to="/Tops"> Tops </Link>
            </div>
            <div className="Self-Categories">
              <img src="https://drive.google.com/uc?export=download&id=1RgoYyGeW6ytpUNov6rJR09lG9EyB9RQ_"></img>
